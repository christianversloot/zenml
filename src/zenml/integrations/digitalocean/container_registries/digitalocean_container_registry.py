...
"""Implementation of the DigitalOcean container registry integration."""
...
from zenml.integrations.digitalocean.flavors.digitalocean_container_registry_flavor import (
...
class DigitalOceanContainerRegistry(BaseContainerRegistry):
    """Class for DigitalOcean Container Registry."""

    @property
    def config(self) -> DigitalOceanContainerRegistryConfig:
        """Returns the `DigitalOceanContainerRegistryConfig` config.

        Returns:
            The configuration.
        """
        return cast(DigitalOceanContainerRegistryConfig, self._config)
